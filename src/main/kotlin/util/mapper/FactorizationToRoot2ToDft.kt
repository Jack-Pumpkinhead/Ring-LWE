...
/**
 * Created by CowardlyLion at 2022/3/5 12:08
 */
open class FactorizationToRoot2ToDft<X0, X1, A>(val f: FactorizationToRoot2<X0, X1, A>, val g: RootToDft<A>) : FactorizationToDft2<X0, X1, A> {
