...
/**
 * Created by CowardlyLion at 2022/3/5 12:01
 */
open class FactorizationToRoot2ToCe<X0, X1, A>(val f: FactorizationToRoot2<X0, X1, A>, val g: RootToCe<A>) : FactorizationToCe2<X0, X1, A> {
