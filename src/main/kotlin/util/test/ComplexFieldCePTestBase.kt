...
/**
 * Created by CowardlyLion at 2022/3/5 13:56
 */
class ComplexFieldCePTestBase(val builder: CeMatrixBuilder<ComplexNumber<Double>>, val statistic: TaskNearMatrixComplexDoubleStatistic<TwoMatrix<ComplexNumber<Double>>> = TaskNearMatrixComplexDoubleStatistic(TwoMatrixMultiplicationTiming())) {

//    val creator = FactorizationToRoot1ToCe(RootCalculatorUnsafeComplexNumber, builder)
