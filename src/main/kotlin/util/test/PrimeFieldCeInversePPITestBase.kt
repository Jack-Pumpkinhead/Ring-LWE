...
/**
 * Created by CowardlyLion at 2022/3/5 13:44
 */
class PrimeFieldCeInversePPITestBase(val builder: CeMatrixBuilder<ModularUInt>, val statistic: TaskTimingStatistic<TwoMatrix<ModularUInt>, AbstractMatrix<ModularUInt>> = TaskTimingStatistic(EqualTwoMatrixMultiplicationTiming())) {
