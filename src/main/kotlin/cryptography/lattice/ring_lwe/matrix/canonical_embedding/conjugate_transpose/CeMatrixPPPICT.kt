 ...
 */
interface CeMatrixPPPICT<A> : AbstractSquareMatrix<A> {
    ...
    override fun elementAtUnsafe(row: UInt, column: UInt): A = root.cachedInversePower(modTimes(root.order.coprimeNumberAtUnsafe(column), row, root.order.value))
