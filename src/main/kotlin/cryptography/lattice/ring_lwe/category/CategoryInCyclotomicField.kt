...
import math.abstract_structure.module.FiniteConcreteCategoryOfFiniteFreeModuleWithBaseOverRing
 ...
 */
class CategoryInCyclotomicField(val order: PrimePowerULong) {
