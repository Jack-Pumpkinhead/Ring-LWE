 ...
 */
class ZeroMatrix<A>(override val ring: Ring<A>, override val rows: UInt, override val columns: UInt) : AbstractConstantValueMatrix<A> {

    override val value: A get() = ring.zero
